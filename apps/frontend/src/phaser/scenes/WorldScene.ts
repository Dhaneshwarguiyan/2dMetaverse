...
export default class WorldScene extends Phaser.Scene{
    ...
    create(){
        ...
        if(this.tile1 && this.tile2){
            this.floor = this.map.createLayer('floor',[this.tile1,this.tile2],0,0);
            this.border = this.map.createLayer('border',[this.tile1,this.tile2],0,0);
            this.decoration1 = this.map.createLayer('decoration1',[this.tile1,this.tile2],0,0);
            this.decoration2 = this.map.createLayer('decoration2',[this.tile1,this.tile2],0,0);
            this.decoration3 = this.map.createLayer('decoration3',[this.tile1,this.tile2],0,0);
            this.player = this.physics.add.sprite(300,400,"player",6);
            this.foreground = this.map.createLayer('foreground',[this.tile1,this.tile2],0,0);
            this.obstacles = this.map.createLayer('obstacles',[this.tile1,this.tile2],0,0);
