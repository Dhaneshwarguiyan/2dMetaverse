...
import { openCreateSpaceDialog, openEntryCodeDialog } from "../slices/toggleSlice";
  ...
  return (
    <div className="flex justify-between items-center mb-5 pb-4 border-b border-gray-300">
      ...
      <div className="flex gap-3">
        ...
        <span onClick={()=>{dispatch(openEntryCodeDialog())}}><Button icon={<Add/>} text="Enter with Code" type="secondary"/></span>
        <span onClick={()=>{dispatch(openCreateSpaceDialog())}}><Button icon={<Add/>} text="Create Space" type="primary"/></span>
      </div>
    </div>
  )
}
